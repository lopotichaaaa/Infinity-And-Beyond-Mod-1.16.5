...
public enum ModArmorMaterial implements IArmorMaterial {
    AMETHYST("end_essence", 40, new int[]{4,7,10,4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0F, 0.1F,
            ()-> Ingredient.fromItems(ModItems.END_ESSENCE.get()));
    ...
    public String getName() {
        return InfinityAndBeyond.MOD_ID+":"+this.name;
    }
